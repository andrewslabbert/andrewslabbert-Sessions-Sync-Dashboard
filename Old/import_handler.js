/*******************************************************************************
 * WP All Import Callback Handler - v1.1
 *
 * Description: Receives secured POST requests from the WP All Import Logger &
 *              Control plugin, verifies a shared secret, routes data based on
 *              import ID, logs results and raw data to specific Google Sheets,
 *              updates CacheService status for completed imports, and provides
 *              a library function for other scripts to retrieve status.
 *
